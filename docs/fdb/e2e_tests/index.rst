...
Extended tests (less common config styles) are gated behind the CMake option
``HAVE_PYTHON_EXTENDED_FDB_TOOL_TESTS``; pass ``-DENABLE_PYTHON_EXTENDED_FDB_TOOL_TESTS=ON``
to enable them.
