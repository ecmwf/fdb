...
FDBTool::FDBTool(int argc, char **argv) : eckit::Tool(argc, argv) {
    ...
    options_.push_back(new eckit::option::SimpleOption<std::string>("date", "keyword class"));
    options_.push_back(new eckit::option::SimpleOption<std::string>("time", "keyword class"));
    options_.push_back(new eckit::option::SimpleOption<std::string>("domain", "keyword class"));
