...
int DecoupledHandler::selectDataPort() {
...
void DecoupledHandler::controlWrite(Message msg, uint32_t requestID, const void* payload, uint32_t payloadLength) {
...
void DecoupledHandler::controlWrite(const void* data, size_t length) {
...
void DecoupledHandler::socketRead(void* data, size_t length, eckit::net::TCPSocket& socket) {
...
void DecoupledHandler::dataWrite(Message msg, uint32_t requestID, const void* payload, uint32_t payloadLength) {

    Log::debug<LibFdb5>() << "DecoupledHandler::dataWrite.  requestID: " << requestID << " payloadLength: " << payloadLength
                            << " msg: " << static_cast<int>(msg) << std::endl;
