...
#ifndef fdb5_RemoteFieldLocationV1_H
#define fdb5_RemoteFieldLocationV1_H
...
class RemoteFieldLocationV1 : public FieldLocation {
public:

    RemoteFieldLocationV1(const FieldLocation& internal, const std::string& hostname, int port);
    RemoteFieldLocationV1(eckit::Stream&);
    RemoteFieldLocationV1(const RemoteFieldLocationV1&);
...
protected: // For Streamable
    ...
    static eckit::Reanimator<RemoteFieldLocationV1> reanimator_;
...
#endif // fdb5_RemoteFieldLocationV1_H
