...
protected: // methods
    ...
    void archive(const uint32_t archiverId, const Key& key, const void *data, eckit::Length length, std::function<void(const std::unique_ptr<FieldLocation> fieldLocation)> catalogue_archive) override;
