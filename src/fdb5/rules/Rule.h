...
public: // methods
    ...
    void expand(const metkit::mars::MarsRequest& request, ReadVisitor& Visitor, size_t depth,
                std::vector<fdb5::TypedKey>& keys, TypedKey& fullComputedKey) const;

    void expand(const Key& initialFieldKey, WriteVisitor& Visitor, size_t depth, std::vector<fdb5::TypedKey>& keys,
...
private: // methods
    ...
    void expand(const Key& initialFieldKey, std::vector<Predicate*>::const_iterator cur, size_t depth,
    ...
    void expandFirstLevel(const metkit::mars::MarsRequest& request, std::vector<Predicate*>::const_iterator cur,
                          TypedKey& result, bool& done) const;
