...
class TypeMonthOfDate : public Type {

public:  // methods

    TypeMonthOfDate(const std::string& name, const std::string& type, const std::string& alias = "month");

    ~TypeMonthOfDate() override;
