...
struct FakeExtractor : public cdv::Extractor {
    ...
    void extract(eckit::DataHandle& handle, const cdv::DataLayout& layout, float* ptr, size_t len) const override {
        ...
        EXPECT_EQUAL(handle.read(ptr, totalBytes), totalBytes);
    };
};
