...
// TODO(TKR) implement this further
...
//         chunked_data_view::AxisDefinition();
//
//         const auto view =
//             cdv::ChunkedDataViewBuilder()
//                 .addPart(keys,
//                          {
//                              chunked_data_view::AxisDefinition{.keys = {first.name()},
//                                                                .chunking =
//                                                                cdv::AxisDefinition::SingleValueChunking{}},
//                              chunked_data_view::AxisDefinition{.keys = {second.name()},
//                                                                .chunking =
//                                                                cdv::AxisDefinition::SingleValueChunking{}},
//                              chunked_data_view::AxisDefinition{.keys = {third.name()},
//                                                                .chunking = cdv::AxisDefinition::NoChunking{}},
//                              chunked_data_view::AxisDefinition{.keys = {fourth.name()},
//                                                                .chunking = cdv::AxisDefinition::NoChunking{}},
//                          },
//                          mock_extractor)
//                 .addPart(keys,
