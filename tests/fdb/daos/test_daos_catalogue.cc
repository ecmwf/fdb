...
CASE( "Setup" ) {
    ...
    // due to no specified schema file (e.g. in CanonicalKey::registry())
...
CASE("DaosCatalogue tests") {
    ...
    SECTION("DaosCatalogue archive (index) and retrieve without a Store") {
        ...
        fdb5::CanonicalKey request_key({{"a", "11"}, {"b", "22"}, {"c", "3"}, {"d", "4"}, {"e", "5"}, {"f", "6"}});
        fdb5::CanonicalKey db_key({{"a", "11"}, {"b", "22"}}, schema.registry());
        fdb5::CanonicalKey index_key({{"c", "3"}, {"d", "4"}}, schema.registry());
        fdb5::CanonicalKey field_key({{"e", "5"}, {"f", "6"}}, schema.registry());
        ...
        std::unique_ptr<fdb5::FieldLocation> loc(new fdb5::DaosFieldLocation(
            eckit::URI{"daos", "test_uri"}, eckit::Offset(0), eckit::Length(1), fdb5::CanonicalKey(nullptr, true)
        ));
    ...
    SECTION("DaosCatalogue archive (index) and retrieve with a DaosStore") {
        ...
        fdb5::CanonicalKey request_key({{"a", "11"}, {"b", "22"}, {"c", "3"}, {"d", "4"}, {"e", "5"}, {"f", "6"}});
        fdb5::CanonicalKey db_key({{"a", "11"}, {"b", "22"}});
        fdb5::CanonicalKey index_key({{"c", "3"}, {"d", "4"}});
        fdb5::CanonicalKey field_key({{"e", "5"}, {"f", "6"}});
    ...
    SECTION("Via FDB API with a DAOS catalogue and store") {
        ...
        fdb5::CanonicalKey request_key({{"a", "11"}, {"b", "22"}, {"c", "3"}, {"d", "4"}, {"e", "5"}, {"f", "6"}});
        fdb5::CanonicalKey db_key({{"a", "11"}, {"b", "22"}});
        fdb5::CanonicalKey index_key({{"a", "11"}, {"b", "22"}, {"c", "3"}, {"d", "4"}});
    ...
    SECTION("OPTIONAL SCHEMA KEYS") {
        ...
        fdb5::CanonicalKey request_key({{"a", "11"}, {"b", "22"}, {"d", "4"}, {"f", "6"}});
        fdb5::CanonicalKey request_key2({{"a", "11"}, {"b", "22"}, {"d", "4"}, {"e", "5"}, {"f", "6"}});
        fdb5::CanonicalKey db_key({{"a", "11"}, {"b", "22"}});
        fdb5::CanonicalKey index_key({{"a", "11"}, {"b", "22"}, {"d", "4"}});
