...
CASE("DaosStore tests") {
    ...
    SECTION("archive and retrieve") {
        ...
        fdb5::CanonicalKey request_key({{"a", "1"}, {"b", "2"}, {"c", "3"}, {"d", "4"}, {"e", "5"}, {"f", "6"}});
        fdb5::CanonicalKey db_key({{"a", "1"}, {"b", "2"}}, schema.registry());
    ...
    SECTION("VIA FDB API") {
        ...
        fdb5::CanonicalKey request_key({{"a", "1"}, {"b", "2"}, {"c", "3"}, {"d", "4"}, {"e", "5"}, {"f", "6"}});
        fdb5::CanonicalKey db_key({{"a", "1"}, {"b", "2"}});
        fdb5::CanonicalKey index_key({{"a", "1"}, {"b", "2"}, {"c", "3"}, {"d", "4"}});
