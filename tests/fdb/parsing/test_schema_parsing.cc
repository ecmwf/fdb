...
CASE("Correct schema (stream) - FDBSC Schema") {

    std::ifstream in("./data/schema_fdbsc");
    EXPECT(in);
...
CASE("Correct schema (stream) - Databridge Schema") {

    std::ifstream in("./data/schema_databridge");
    EXPECT(in);
