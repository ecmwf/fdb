...
def test_list_all(simple_fdb_setup_no_subtocs_no_expver_handler, data_path, function_tmp, no_files_saved):
    # Data setup
    ...
    with FDB(simple_fdb_setup_no_subtocs_no_expver_handler) as fdb:
...
def test_list_all_including_masked(simple_fdb_setup_no_subtocs_no_expver_handler, data_path, function_tmp):
...
def test_list_location(simple_fdb_setup_no_subtocs_no_expver_handler, data_path, function_tmp):
    fdb = FDB(simple_fdb_setup_no_subtocs_no_expver_handler)
...
def test_list_masking(simple_fdb_setup_no_subtocs_no_expver_handler, data_path, function_tmp):
    fdb = FDB(simple_fdb_setup_no_subtocs_no_expver_handler)
...
def test_list_ranges_include_masked(simple_fdb_setup_no_subtocs_no_expver_handler, data_path, function_tmp):
    fdb = FDB(simple_fdb_setup_no_subtocs_no_expver_handler)
...
def test_list_ranges(
    simple_fdb_setup_no_subtocs_no_expver_handler, data_path, function_tmp, selection, expected_entries
):
    fdb = FDB(simple_fdb_setup_no_subtocs_no_expver_handler)
