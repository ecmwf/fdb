...
[[ "$(find . -name '*.index.extra' | wc -l | tr -d '[:space:]')" != "2" ]] && echo "Extra files created incorrectly" && exit -1
...
[[ "$(find . -name '*.index' | wc -l | tr -d '[:space:]')" != "2" ]] && echo "Nothing should be removed with extra data" && exit -1
[[ "$(find . -name '*.index.extra' | wc -l | tr -d '[:space:]')" != "2" ]] && echo "Nothing should be removed with extra data" && exit -1
