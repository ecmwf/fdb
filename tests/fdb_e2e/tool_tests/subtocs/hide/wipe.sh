...
[[ "$(find . -name toc | wc -l| tr -d '[:space:]')" != "2" ]] && echo "Incorrect data present" && exit -1
[[ "$(find . -name "toc.*" | wc -l| tr -d '[:space:]')" != "4" ]] && echo "Incorrect data present" && exit -1
[[ "$(find . -name "*.data" | wc -l| tr -d '[:space:]')" != "4" ]] && echo "Incorrect data present" && exit -1
[[ "$(find . -name "*.index" | wc -l| tr -d '[:space:]')" != "8" ]] && echo "Incorrect data present" && exit -1
